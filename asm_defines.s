...
.equ ITEM_DREAM_MIST, 0x2D9
.equ ITEM_PEAT_BLOCK, 0x2DA
.equ ITEM_BLACK_AUGURITE, 0x2DB
.equ ITEM_HISUI_ROCK, 0x2DC
.equ ITEM_REINS_OF_UNITY, 0x2DD
.equ ITEM_LOADED_DICE, 0x2DE
.equ ITEM_X_SP_DEF, 0x2DF
...
@Pokeball
.equ BALL_TYPE_MASTER_BALL,	0
.equ BALL_TYPE_ULTRA_BALL,	1
.equ BALL_TYPE_GREAT_BALL,	2
.equ BALL_TYPE_POKE_BALL,	3
.equ BALL_TYPE_SAFARI_BALL,	4
.equ BALL_TYPE_NET_BALL,	5
.equ BALL_TYPE_DIVE_BALL,	6
.equ BALL_TYPE_NEST_BALL,	7
.equ BALL_TYPE_REPEAT_BALL,	8
.equ BALL_TYPE_TIMER_BALL,	9
.equ BALL_TYPE_LUXURY_BALL,	10
.equ BALL_TYPE_PREMIER_BALL, 11
.equ BALL_TYPE_DUSK_BALL,	12
.equ BALL_TYPE_HEAL_BALL,	13
.equ BALL_TYPE_QUICK_BALL,	14
.equ BALL_TYPE_CHERISH_BALL, 15
.equ BALL_TYPE_PARK_BALL,	16
.equ BALL_TYPE_FAST_BALL,	17
.equ BALL_TYPE_LEVEL_BALL,	18
.equ BALL_TYPE_LURE_BALL,	19
.equ BALL_TYPE_HEAVY_BALL,	20
.equ BALL_TYPE_LOVE_BALL,	21
.equ BALL_TYPE_FRIEND_BALL,	22
.equ BALL_TYPE_MOON_BALL,	23
.equ BALL_TYPE_SPORT_BALL,	24
.equ BALL_TYPE_BEAST_BALL,	25
.equ BALL_TYPE_DREAM_BALL,	26

@Specials
.equ HealPlayerParty, 0x0 
@0x1 To 0x6 Are link cable stuff
.equ PokemonEVContestStatsChecker, 0x7
.equ PokemonIVChecker, 0x8
.equ PokemonRibbonChecker, 0x9
.equ CheckPokerusTime, 0xA
.equ CheckPokeBall, 0xB
.equ CheckCaptureLocation, 0xC
.equ CheckHappiness, 0xD
.equ CheckHedlItem, 0xE
.equ EVAdderSubtracter, 0xF
.equ IVSetter, 0x10
.equ RibbonSetterCleaner, 0x11
.equ PokerusSetter, 0x12
.equ IncreaseDecreaseHappiness, 0x13
.equ ChangeCapturedBall, 0x14
.equ ModifyHeldItem, 0x15
.equ ChangePokemonSpecies, 0x15
.equ ChangePokemonAttacks, 0x17
.equ CheckPokemonSpecies, 0x18
.equ CheckAttackPP, 0x19
.equ CopyPartyData, 0x1A
.equ SwapPartyAndBoxData, 0x1B
@0x1C to 0x23 is more link stuff
.equ AddTextByVariable, 0x24
.equ AddTextByPointer, 0x25
@
.equ SavePlayerParty, 0x27
.equ LoadPlayerParty, 0x28
.equ ChooseHalfPartyForBattle, 0x29
.equ Script_ShowLinkTrainerCard, 0x2A
.equ CheckABButtons, 0x2B
.equ CheckDPad, 0x2C
.equ CheckStartSelect, 0x2D
.equ CheckLRButtons, 0x2E
.equ KeyDump, 0x2F
@
.equ GetTrainerBattleMode, 0x36
.equ ShowTrainerIntroSpeech, 0x37
.equ ShowTrainerCantBattleSpeech, 0x38
.equ GetTrainerFlag, 0x39
.equ DoTrainerApproach, 0x3A
.equ PlayTrainerEncounterMusic, 0x3B
.equ ShouldTryRematchBattle, 0x3C
.equ IsTrainerReadyForRematch, 0x3D
.equ AddVariables, 0x3E
.equ SubtractVariables, 0x3F
.equ MultiplyVariables, 0x40
.equ DivideVariables, 0x41
.equ ANDVariables, 0x42
.equ ORVariables, 0x43
.equ XORVariables, 0x44
.equ HasLeadMonBeenRenamed, 0x45
.equ StartTimer, 0x46
.equ HaltTimer, 0x47
.equ ResumeTimer, 0x48
.equ StopTimer, 0x49
.equ GetTimerValue, 0x4A
.equ StopAndUpdatePlaytime, 0x4B
.equ UpdatePlaytime, 0x4C
.equ TimerValueReached, 0x4D
.equ SaveTimerValue, 0x4E
.equ StartTimerAtTime, 0x4F
.equ StoreTimerToVariable, 0x50
.equ CanTeamParticipateInSkyBattle, 0x51
.equ GenerateFacilityTrainer, 0x52
.equ LoadFrontierIntroBattleMessage, 0x53
.equ GetBattleFacilityStreak, 0x54
.equ UpdateBattleFacilityStreak, 0x55
.equ DetermineBattlePointsToGive, 0x56
.equ ShowFrontierRecords, 0x57
.equ BufferSwarmText, 0x58
.equ BufferSpeciesRoamingText, 0x59
.equ WildDataSwitch, 0x5A
.equ WildDataSwitchCanceller, 0x5B
...
.equ LoadTimerFromVariable, 0x61
.equ PokemonEraser, 0x62
.equ StatusChecker, 0x63
.equ InflictStatus, 0x64
.equ CheckMonHP, 0x65
.equ InflictPartyDamage, 0x66
.equ GenerateRandomBattleTowerTeam, 0x67
.equ GivePlayerFrontierMonGivenSpecies, 0x68
.equ GivePlayerRandomFrontierMonByTier, 0x69
.equ GivePlayerFrontierMonByLoadedSpread, 0x6A
.equ ReplacePlayerTeamWithMultiTrainerTeam, 0x6B
.equ SpliceFrontierTeamWithPlayerTeam, 0x6C
.equ LoadFrontierMultiTrainerById, 0x6D
.equ BufferBattleSandsRecords, 0x6E
.equ CanTeamParticipateInBattleMine, 0x6F
.equ RandomizeBattleMineBattleOptions, 0x70
.equ LoadBattleMineRecordTier, 0x71
.equ LoadBattleCircusEffects, 0x72
.equ ModifyTeamForBattleTower, 0x73
@IsPokemonStorageFull, 0x74 - Predefined in vanilla FR
.equ MeasurePokemon1, 0x75
.equ MeasurePokemon2, 0x76
...
.equ BufferNickname, 0x7C
.equ CheckTradedPokemon, 0x7D
.equ GetTileNumber, 0x7E
.equ GetTileBehaviour, 0x7F
.equ BufferRandomHobbyOrLifestyleString, 0x80
.equ SetWalkingScript, 0x81
.equ RegisteredItemHandleBikeSwap, 0x82
.equ CalculatePlayerPartyCount, 0x83
.equ CountPartyNonEggMons, 0x84
.equ CountPartyAliveNonEggMons_IgnoreVar4Slot, 0x85
.equ GetSafariBalls, 0x86
.equ ChangeSafariBalls, 0x87
.equ GetSafariCounter, 0x88
.equ SetSafariCounter, 0x89
.equ ReadPedometerValue, 0x8A
...
.equ StartGroundBattle, 0x97
.equ StartWaterBattle, 0x98
.equ Overworld_PlaySpecialMapMusic, 0x99
.equ StopSounds, 0x9A
.equ OldManBattleModifier, 0x9C
.equ StartOldManTutorialBattle, 0x9D
.equ NicknamePokemon, 0x9E
.equ ChoosePartyMon, 0x9F
.equ CheckAndSetDailyEvent, 0xA0
.equ UpdateTimeInVars, 0xA1
.equ GetTimeDifference, 0xA2
...
.equ LoadTrainerBDefeatText, 0xAC
.equ GetTimeOfDay, 0xAD
.equ ClearFlag, 0xAE
.equ DismountBicyle, 0xAF
.equ LoadPartyPokemonTypes, 0xB0
.equ ChooseItemFromBag, 0xB1
.equ PokemonTypeInParty, 0xB2
.equ DoChooseNumberScreen, 0xB3
...
.equ IsEnoughForCostInVar5, 0xC5
.equ SubtractMoneyFromVar5, 0xC6
.equ TryFieldPoisonWhiteOut, 0xC7
.equ SetCB2WhiteOut, 0xC8
.equ ForceOneKeyInput, 0xC9
.equ IgnoreKeys, 0xCA
.equ PlaceKeyScript, 0xCB
.equ CanLearnDracoMeteorInParty, 0xCC
.equ EnterSafariMode, 0xCD
.equ ExitSafariMode, 0xCE
.equ BufferAbilityName, 0xCF
.equ PokemonInPartyThatCanLearnTMHM, 0xD0
.equ SetUpFollowerSprite, 0xD1
.equ DestroyFollowerSprite, 0xD2
.equ FaceFollowerSprite, 0xD3
...
.equ DoesPlayerHaveFollower, 0xE1
.equ IsDexNavCompleteHere, 0xE2
.equ GetPlayerAvatarBike, 0xE3
.equ ShowItemSpriteOnFindObtain, 0xE4
.equ ClearItemSpriteAfterFindObtain, 0xE5
.equ GetLeadMonFriendship, 0xE6
.equ CreateFrontierOpponentTeamBeforeBattle, 0xE7
.equ BufferRingChallengeOpponentTeamDetails, 0xE8
.equ ChooseRingChallengeOpponentMon, 0xE9
.equ BufferRingChallengeRecords, 0xEA
...
.equ CanPlayerUseFlashInCurrentLocation, 0x100
.equ CanPlayerFlyInCurrentLocation, 0x101
.equ IsPlayerFacingSurfableWater, 0x102
.equ IsPlayerFacingClimbableWaterfall, 0x103
.equ IsPlayerOnDiveableWater, 0x104
.equ IsPlayerFacingClimbableWall, 0x105
.equ CreatePCMenu, 0x106
.equ HallOfFamePCBeginFade, 0x107
.equ ShowDiploma, 0x108
.equ IsPlayerFacingNPCWithOverworldPic, 0x109
.equ CanUseCutOnTree, 0x10A
.equ CanUseRockSmashOnRock, 0x10B
.equ CanUseStrengthOnBoulder, 0x10C
.equ LookThroughPorthole, 0x10E
.equ DoSoftReset, 0x10F
.equ EnterHallOfFame, 0x110
.equ AnimateElevator, 0x111
.equ BufferNaturalGiftPowerAndType, 0x112
.equ SpawnCameraObject, 0x113
.equ RemoveCameraObject, 0x114
.equ RaidBattleAvailable, 0x115
.equ StartRaidBattleIntro, 0x116
.equ CreateRaidMon, 0x117
.equ StartRaidBattle, 0x118
.equ SetRaidBattleFlag, 0x119
.equ ClearRaidBattleFlag, 0x11A
.equ AllRaidBattlesCompleted, 0x11B
.equ GiveRaidBattleRewards, 0x11C
...
.equ DoEnterPhraseScreen, 0x12C
.equ CompareEnteredPhrase, 0x12D
...
.equ StartGhostBattle, 0x156
.equ ScrollingMutichoice, 0x158
.equ CheckAddCoins, 0x15E
.equ GetDaycarePokemonCount, 0x15F
.equ GetStarterChoice, 0x162
