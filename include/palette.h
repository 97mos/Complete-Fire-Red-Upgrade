...
void __attribute__((long_call)) CopyPaletteInvertedTint(const u16 *src, u16 *dst, u16 count, u8 a4);
void __attribute__((long_call)) BlendPalettesGradually(u32 a1, s8 a2, u8 a3, u8 a4, u16 a5, u8 a6, u8 a7);
